...
from infra.apps import base
from infra.config import Config
from infra.utils.debug import log_sketch
from infra.apps.federated_learning.trainers \
    import registry as trainers_registry
from infra.apps.federated_learning.datasources \
    import registry as datasources_registry
from infra.apps.federated_learning.samplers \
...
from infra.apps.federated_learning.payload import Payload
...
def _get_client_dataset_size(clients):
    ...
    for client_id in clients:
        ...
        result[client_id] = temp_datasource.get_num_train_examples()
    return result
